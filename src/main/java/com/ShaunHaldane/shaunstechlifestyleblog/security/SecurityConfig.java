package com.ShaunHaldane.shaunstechlifestyleblog.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public AccessDeniedHandler accessDeniedHandler() {
		return new PostAccessDeniedHandler();
	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
			.antMatchers("/", "/login", "/home")
				.permitAll()
			.antMatchers("/addPost", "/editPost", "/deletePost")
				.hasAnyRole("ADMIN")
			.antMatchers("/addComment")
				.hasAnyRole("CLIENT")
			.and()
				.formLogin()
				.loginPage("/login")
